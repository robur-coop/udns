...
val lookup_any : 'a Domain_name.t -> t ->
  (Rr_map.t * ([ `domain ] Domain_name.t * int32 * Domain_name.Host_set.t), e) result
...
val fold : 'a Rr_map.key -> t -> ([ `domain ] Domain_name.t -> 'a -> 'b -> 'b) -> 'b -> 'b
