...
val handle : t -> Ptime.t -> int64 -> bool -> Udns_types.proto -> Ipaddr.V4.t -> int -> Cstruct.t ->
  t * (Udns_types.proto * Ipaddr.V4.t * int * Cstruct.t) list
    * (Udns_types.proto * Ipaddr.V4.t * Cstruct.t) list
...
val query_root : t -> int64 -> Udns_types.proto ->
  t * (Udns_types.proto * Ipaddr.V4.t * Cstruct.t)
