...
module Packet = struct
  ...
  let regression0 () =
    ...
    and content =
      let soa = {
      Soa.nameserver = Domain_name.host_exn (n_of_s "CON1R.NIPR.MIL") ;
      hostmaster =
  ...
  let regression2 () =
    ...
    and content =
      let soa = {
        Soa.nameserver = Obj.magic (n_of_s "212.58.230.200") ;
  ...
  let regression4 () =
    ...
    and authority =
      let soa = { Soa.nameserver = Domain_name.(host_exn (of_string_exn "primary.riseup.net")) ;
...
|}
    ...
    and an, additional =
      ...
      Domain_name.Map.singleton (n_of_s "ccc.de")
        (Rr_map.add Soa {
            Soa.nameserver = Domain_name.host_exn (n_of_s "ns.ham.ccc.de") ; hostmaster = n_of_s "hostmaster.ccc.de" ;
