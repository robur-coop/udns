...
type 'key query_state constraint 'key = 'a Udns.Umap.k
...
val make_query :
  ...
  'query_type Udns.Umap.k->
  Cstruct.t * 'query_type Udns.Umap.k query_state
...
val parse_response : 'query_type Udns.Umap.k query_state -> Cstruct.t ->
