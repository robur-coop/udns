...
type 'key query_state constraint 'key = 'a Udns.Map.k
...
val make_query :
  ...
  'query_type Udns.Map.k->
  Cstruct.t * 'query_type Udns.Map.k query_state
...
val parse_response : 'query_type Udns.Map.k query_state -> Cstruct.t ->
