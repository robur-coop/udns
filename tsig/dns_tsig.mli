...
val encode_and_sign : ?proto:proto -> Packet.t -> Ptime.t -> Dns.Dnskey.t ->
  [ `domain ] Domain_name.t -> (Cstruct.t * Cstruct.t, s) result
...
val decode_and_verify : Ptime.t -> Dnskey.t -> [ `domain ] Domain_name.t ->
...
(**/**)
val compute_tsig : [ `domain ] Domain_name.t -> Tsig.t -> key:Cstruct.t ->
  Cstruct.t -> Cstruct.t
